...
-- Остаток на ващем счете состевляет 1 283 рубля 33 копейки
...
object MainScenario: Scenario(
    ...
    init {
        ...
        state("balance") {
            ...
            action {
                reactions.say("Остаток на ващем счете составляет тысяча двести восемьдесят три рубля тридцать три копейки")
            }
        }
